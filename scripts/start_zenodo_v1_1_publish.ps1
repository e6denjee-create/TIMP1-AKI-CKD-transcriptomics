...
$prepare = Join-Path $PSScriptRoot "prepare_zenodo_v1_1.py"
$publisher = Join-Path $PSScriptRoot "publish_zenodo_v1_1.py"
$log = Join-Path $projectRoot "public_repository\zenodo_v1.1.0_publish.log"

Set-Location -LiteralPath $projectRoot

Write-Host "Preparing Zenodo v1.1.0 archive..." -ForegroundColor Cyan
& $python $prepare
...
try {
    ...
    Write-Host "Token received. Creating and uploading Zenodo v1.1.0..." -ForegroundColor Green
    ...
    Write-Host "Zenodo v1.1.0 publication completed." -ForegroundColor Green
}
catch {
