"""Create and split the Zenodo v1.2.0 archive."""
...
ARCHIVE = ROOT / "public_repository" / "TIMP1_AKI_CKD_transcriptomics_zenodo_v1.2.0.zip"
...
def main() -> None:
    ...
    with ARCHIVE.open("rb") as source:
        ...
        while chunk := source.read(PART_SIZE):
            ...
            index += 1
    with (PARTS_DIR / "PARTS_MANIFEST.csv").open(
    ...
    (PARTS_DIR / "README_REASSEMBLY.txt").write_text(
        "Reassemble the ZIP by concatenating all .part files in filename order.\n"
